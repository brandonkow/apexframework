...
import { installLearningOwner } from "../assistant/learning-owner.js";
...
export function createWorkspace({ getCandidate, notify, onVisibility, beforeOpen }) {
  ...
  host.querySelector("#studioSectionSelect").setAttribute("aria-label", "Workspace section");
  installLearningOwner(host);
